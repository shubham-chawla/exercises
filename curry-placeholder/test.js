...
describe('curry', function() {
  ...
  it('curries the function until the arguments needed are given at least once with placeholder', function() {
    const _ = curry.placeholder
    var add = curry(function(a, b, c) {
      return a + b + c;
    });
    assert.equal(add(_, 2)(1)(3), 6);
    assert.equal(add(_, 2)(_)(1)(3), 6);
    assert.equal(add(_, _, 2)(1)(3), 6);
    assert.equal(add(_, _, _)(2)(1)(3), 6);
  });
